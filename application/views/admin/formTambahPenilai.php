...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Tambah Tim Penilai</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Tambah Tim Penilai</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						<form action="<?= base_url() . 'C_Admin/tambahPenilai' ?>" method="post"
							id="formTambahTimPenilai">
							<div class="card-header">
								<h3 class="card-title">Tambah Data Tim Penilai</h3>
							</div>
							<!-- /.card-header -->
							<div class="card-body">
...
<script>
	...
	function resetForm(event) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				document.getElementById('formTambahTimPenilai').reset();
			}
		})
	};
	...
	function simpan(event) {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				document.getElementById('formTambahTimPenilai').submit();
			}
		})
	};
